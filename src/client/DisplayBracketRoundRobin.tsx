...
export default function DisplayBracketRoundRobin(props: any) {
    ...
    return (false ? <h1>Round Robin Bracket</h1> :
        <>
          ...
          <>
            ...
            <div className="div-for-bracket_header-and-full_bracket">
                ...
                <div className="full_bracket">
                    <div className="round">
                        <h2 className="text-center" style={{ textDecoration: "underline" }}>Round 1</h2>
                        {bouts.map((bout, index) => {
                            //I'm not sure where this logic belongs. I would imagine it belongs in the SingleBoutForDisplayBracket component. Ask wc.
                            const cardClasses = classNames("my-2", "mx-1", "col-10", {
                                "the-card-border": bout.id % 2 === 0,
                    ...
                    <div className="round">
                        <h2 className="text-center" style={{ textDecoration: "underline" }}>Round 2</h2>
                        {bouts.map((bout, index) => {
                            //I'm not sure where this logic belongs. I would imagine it belongs in the SingleBoutForDisplayBracket component. Ask wc.
                            const cardClasses = classNames("my-2", "mx-1", "col-10", {
                                "the-card-border": bout.id % 2 === 0,
                    ...
                    <div className="round">
                        <h2 className="text-center" style={{ textDecoration: "underline" }}>Round 3</h2>
                        {bouts.map((bout, index) => {
                            //I'm not sure where this logic belongs. I would imagine it belongs in the SingleBoutForDisplayBracket component. Ask wc.
                            const cardClasses = classNames("my-2", "mx-1", "col-10", {
                                "the-card-border": bout.id % 2 === 0,
                    ...
                    <div className="round">
                        <h2 className="text-center" style={{ textDecoration: "underline" }}>Round 4</h2>
                        {bouts.map((bout, index) => {
                            //I'm not sure where this logic belongs. I would imagine it belongs in the SingleBoutForDisplayBracket component. Ask wc.
                            const cardClasses = classNames("my-2", "mx-1", "col-10", {
                                "the-card-border": bout.id % 2 === 0,
                    ...
                    <div className="round">
                        <h2 className="text-center" style={{ textDecoration: "underline" }}>Round 5</h2>
                        {bouts.map((bout, index) => {
                            //I'm not sure where this logic belongs. I would imagine it belongs in the SingleBoutForDisplayBracket component. Ask wc.
                            const cardClasses = classNames("my-2", "mx-1", "col-10", {
                                "the-card-border": bout.id % 2 === 0,
                    ...
                    <div className="round">
                        <h2 className="text-center" style={{ textDecoration: "underline" }}>Round 6</h2>
                        {bouts.map((bout, index) => {
                            //I'm not sure where this logic belongs. I would imagine it belongs in the SingleBoutForDisplayBracket component. Ask wc.
                            const cardClasses = classNames("my-2", "mx-1", "col-10", {
                                "the-card-border": bout.id % 2 === 0,
                    ...
                    <div className="round">
                        <h2 className="text-center" style={{ textDecoration: "underline" }}>Round 7</h2>
                        {bouts.map((bout, index) => {
                            //I'm not sure where this logic belongs. I would imagine it belongs in the SingleBoutForDisplayBracket component. Ask wc.
                            const cardClasses = classNames("my-2", "mx-1", "col-10", {
                                "the-card-border": bout.id % 2 === 0,
